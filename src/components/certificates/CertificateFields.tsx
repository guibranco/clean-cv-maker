          ...
          {topics.map((topic, topicIndex) => (
            <div key={topic.id} className="flex items-center gap-2">
              ...
              <input
                ...
                className="flex-1 rounded-md border border-gray-300 dark:border-gray-600 px-3 py-2 shadow-xs focus:border-green-500 focus:outline-hidden focus:ring-1 focus:ring-green-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
              />
              <Button
                type="button"
                variant="outline"
