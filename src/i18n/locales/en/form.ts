    ...
    personalInfo: {
      ...
      fullName: {
        ...
        tooltip: {
          ...
          importance:
            'Why it matters: This is often the first thing recruiters see and is used for ATS matching.',
      ...
      professionalTitle: {
        ...
        tooltip: {
          ...
          importance:
            'Why it matters: Helps recruiters quickly understand your career level and expertise.',
      ...
      location: {
        ...
        tooltip: {
          ...
          importance:
            "Why it matters: Location is crucial for determining job eligibility and helps recruiters assess if you're in their target market.",
      ...
      email: {
        ...
        tooltip: {
          ...
          importance:
            "Why it matters: This is the primary way recruiters will contact you. It's essential for ATS systems and follow-up communications.",
      ...
      phone: {
        ...
        tooltip: {
          ...
          importance:
            'Why it matters: A secondary but crucial contact method. Some recruiters prefer calling for initial screenings.',
      ...
      githubUrl: {
        ...
        tooltip: {
          ...
          importance:
            'Why it matters: Shows your open-source contributions and coding activity. Many tech companies specifically look for this.',
      ...
      linkedinUrl: {
        ...
        tooltip: {
          ...
          importance:
            'Why it matters: LinkedIn is a standard reference point for recruiters to verify your experience and network.',
      ...
      portfolioUrl: {
        ...
        tooltip: {
          ...
          importance:
            'Why it matters: Provides a deeper look at your work and personality. Great for showcasing projects not on GitHub.',
      ...
      willRelocate: {
        ...
        tooltip: {
          ...
          importance:
            'Why it matters: Helps recruiters match you with opportunities in different locations. Can open up more job possibilities.',
      ...
      bio: {
        ...
        placeholder:
          'Write a brief professional summary highlighting your expertise and career goals...',
        tooltip: {
          content: 'A brief professional summary highlighting your expertise and career goals.',
          importance:
            "Why it matters: This is your elevator pitch. It's often the first paragraph recruiters read and helps them quickly understand your value proposition.",
