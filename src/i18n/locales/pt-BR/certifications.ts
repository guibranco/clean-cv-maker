export const certifications = {
  ...
  name: {
    ...
    tooltip: {
      ...
      importance:
        'Isso é o que aparece no seu currículo e ajuda recrutadores a entender suas qualificações.',
  ...
  dates: {
    ...
    expiryDate: {
      ...
      tooltip: {
        ...
        importance:
          'Algumas certificações requerem renovação, mostrando que você mantém conhecimento atualizado.',
  ...
  isPaid: {
    ...
    warning:
      'Certificações gratuitas podem ser vistas com menos favorecimento por alguns empregadores. Considere incluir apenas as mais relevantes.',
  },
  topics: {
    ...
    tooltip: {
      ...
      importance:
        'Mostra o conhecimento específico e competências validadas por esta certificação.',
