export const workExperience = {
  ...
  companyName: {
    ...
    tooltip: {
      ...
      importance: "Este é um campo chave para sistemas ATS e ajuda recrutadores a verificar seu histórico de emprego.",
  ...
  companyLogo: {
    ...
    tooltip: {
      ...
      importance: "Adicionar elementos visuais pode tornar seu currículo mais atraente e memorável.",
  ...
  companySize: {
    ...
    tooltip: {
      ...
      importance: "Ajuda recrutadores a entender a escala das organizações com as quais você trabalhou.",
  ...
  industry: {
    ...
    tooltip: {
      ...
      importance: "Mostra sua experiência em diferentes setores e ajuda na correspondência com vagas específicas da indústria.",
  ...
  description: {
    ...
    tooltip: {
      ...
      importance: "Fornece contexto sobre seu ambiente de trabalho e ajuda recrutadores a entender o foco da empresa.",
  ...
  contractType: {
    ...
    tooltip: {
      ...
      importance: "Esclarece seu status de emprego e ajuda a corresponder com oportunidades similares.",
  ...
  workSchema: {
    ...
    tooltip: {
      ...
      importance: "A flexibilidade do local de trabalho é cada vez mais importante para empregadores e funcionários.",
  ...
  role: {
    title: {
      ...
      tooltip: {
        ...
        importance: "Os títulos dos cargos são fundamentais para correspondência ATS e mostrar progressão na carreira.",
