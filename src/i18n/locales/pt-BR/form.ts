    ...
    personalInfo: {
      ...
      location: {
        ...
        tooltip: {
          ...
          importance: "Por que importa: A localização é crucial para determinar a elegibilidade do trabalho e ajuda os recrutadores a avaliar se você está em seu mercado-alvo.",
      ...
      email: {
        ...
        tooltip: {
          ...
          importance: "Por que importa: Esta é a principal forma de contato dos recrutadores. É essencial para sistemas ATS e comunicações de acompanhamento.",
      ...
      phone: {
        ...
        tooltip: {
          ...
          importance: "Por que importa: Um método secundário, mas crucial, de contato. Alguns recrutadores preferem ligar para triagens iniciais.",
      ...
      githubUrl: {
        ...
        tooltip: {
          ...
          importance: "Por que importa: Mostra suas contribuições open-source e atividade de código. Muitas empresas de tecnologia procuram especificamente por isso.",
      ...
      linkedinUrl: {
        ...
        tooltip: {
          ...
          importance: "Por que importa: LinkedIn é um ponto de referência padrão para recrutadores verificarem sua experiência e rede.",
      ...
      portfolioUrl: {
        ...
        tooltip: {
          ...
          importance: "Por que importa: Fornece uma visão mais profunda do seu trabalho e personalidade. Ótimo para mostrar projetos que não estão no GitHub.",
      ...
      willRelocate: {
        ...
        tooltip: {
          ...
          importance: "Por que importa: Ajuda os recrutadores a combinar você com oportunidades em diferentes locais. Pode abrir mais possibilidades de trabalho.",
      ...
      bio: {
        ...
        tooltip: {
          ...
          importance: "Por que importa: Este é seu elevator pitch. É frequentemente o primeiro parágrafo que os recrutadores leem e os ajuda a entender rapidamente sua proposta de valor.",
    ...
    experience: {
      ...
      experienceYears: {
        ...
        startDate: {
          ...
          tooltip: {
            ...
            importance: "Por que importa: Mostra a profundidade da sua experiência em áreas específicas.",
      ...
      projectsWorked: {
        ...
        tooltip: {
          ...
          importance: "Por que importa: Demonstra sua experiência prática e diversidade de projetos.",
    ...
    languages: {
      ...
      proficiency: {
        ...
        tooltip: {
          ...
          importance: "Por que importa: Ajuda empregadores a entender suas habilidades de comunicação em diferentes idiomas.",
